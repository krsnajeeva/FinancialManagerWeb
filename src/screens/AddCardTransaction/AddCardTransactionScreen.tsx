        ...
        >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '10px' }}>
              <div
                style={{
                  ...
                  height: '28px',
                  borderRadius: '14px',
                  backgroundColor: theme.isDark ? '#2D2D2D' : theme.accent + '1F',
                  display: 'flex',
          ...
          <button
            ...
            style={{
              ...
              alignItems: 'center',
              justifyContent: 'center',
              backgroundColor: isFormValid ? theme.accent : (theme.isDark ? '#2D2D2D' : '#FAFAFA'),
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: isSelected ? theme.accent + '14' : theme.cardBackground,
                        cursor: 'pointer',
                        textAlign: 'left',
                        outline: 'none',
                      }}
